 ...
 */
-(NSDate*)getNearestWeekdayFromYear:(NSUInteger)currentYear month:(NSUInteger)currentMonth day:(NSUInteger)targetDay;
...
-(NSDate*)getNearestWeekdayFromYear:(NSUInteger)currentYear month:(NSUInteger)currentMonth day:(NSUInteger)targetDay
{
	...
	{
        int adjusted = (int)targetDay + [adjustment intValue];
